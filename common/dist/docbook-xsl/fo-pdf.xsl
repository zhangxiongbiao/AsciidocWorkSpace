...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="pickfont-sans">
    <xsl:text>Arial,sans-serif,simkai,Bold-bold</xsl:text>
  </xsl:template>

  <xsl:template name="pickfont-serif">
    <xsl:text>Bold-bold,Georgia,serif</xsl:text>
  </xsl:template>

  <xsl:template name="pickfont-mono">
    <xsl:text>Liberation Mono,Courier New,Courier,monospace,Bold_italic</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="pickfont-symbol">
    <xsl:text>Bold-bold</xsl:text>
  </xsl:template>

  <xsl:template name="pickfont-math">
    <xsl:text>Bold-bold,italic,Bold_italic,Liberation Serif,Times-Roman</xsl:text>
  </xsl:template>
-->

  <!-- 指定文本内容字体 -->
  <xsl:template name="pickfont-sans">
    <xsl:text>notoserif,Arial,sans-serif,simkai,mplus1p</xsl:text>
  </xsl:template>

  <!-- 指定文档标题字体 -->
  <xsl:template name="pickfont-serif">
    <xsl:text>notoserif,Georgia,serif,simkai,mplus1p</xsl:text>
  </xsl:template>

  <xsl:template name="pickfont-mono">
    <xsl:text>Liberation Mono,Courier New,Courier,monospace,simkai,mplus1p</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="pickfont-symbol">
    <xsl:text>simkai,mplus1p</xsl:text>
  </xsl:template>

  <!--指定引用内容的字体-->
  <xsl:template name="pickfont-math">
    <xsl:text>simkai,Liberation Serif,Times-Roman,mplus1p</xsl:text>  
  </xsl:template>
